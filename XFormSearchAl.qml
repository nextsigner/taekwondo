...
Item {
    ...
    Settings{
        id: usFormSearch
        fileName: pws+'/'+app.moduleName+'/'+app.moduleName+'_xsearchal'
    ...
    Column{
        ...
        Row{
            ...
            ComboBox{
                ...
                currentIndex: app.colsNameDatosAlumnos.indexOf(usFormSearch.searchBy)
                            ...
                            Repeater{
                                ...
                                Rectangle{
                                    ...
                                    UText{
                                        ...
                                        Component.onCompleted: {
                                            if(index===3||index===4){
                                                /*l*et d=new Date(parseInt(xRowDes.arrayModeloDatos[index]))
                                                let dia=''+d.getDate()
                                                if(d.getDate()<10){
                                                    dia='0'+dia
                                                }
    ...
    function search(){
        ...
        if(usFormSearch.orderBy===''){
            ...
            sOrderByAndAsc+=app.colsDatosAlumnos[cbPor.currentIndex]+' '+ascDesc
        }
        ...
        b+='\''
        var sql='select distinct * from '+app.tableName2+' where '+b+' '+sOrderByAndAsc
        //console.log('Sql: '+sql)
